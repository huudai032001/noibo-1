...
import { getLastMonthDate } from '../utils/payslip-helpers'
...
export function usePhieuLuongUrl(
  selectedDate: Ref<Date>,
  onMonthFromUrl: (date: Date) => void,
) {
  ...
  function initDateFromUrl(): Date {
    return readDateFromQuery() ?? getLastMonthDate()
  }
